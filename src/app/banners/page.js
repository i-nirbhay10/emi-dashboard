        ...
        <div className="flex flex-wrap items-center gap-1.5 text-xs">
          {[
            ...
            <button
              ...
              className={`px-3 py-1.5 rounded-lg font-medium transition-all ${placementFilter === chip.id
              ...
              >
                <div className="space-y-3">
                  <div className="flex justify-between items-start gap-2">
                    <span className={`px-2.5 py-1 text-xs font-semibold rounded-full border ${banner.placement === 'Homepage Hero' ? 'bg-amber-50 text-amber-700 border-amber-200' :
